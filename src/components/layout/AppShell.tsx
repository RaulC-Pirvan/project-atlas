      ...
      <div className="pt-14">
        ...
        <div className="flex min-h-[calc(100vh-56px)] flex-col">
          <div className="mx-auto w-full max-w-6xl flex-1">
            <main className="flex-1 px-4 pb-24 pt-6 sm:px-6 sm:pt-10 md:pl-72 md:pb-10">
          ...
          <footer className="mb-[calc(56px+env(safe-area-inset-bottom))] border-t border-[color:var(--color-border-subtle)] px-4 py-6 text-center text-xs uppercase tracking-[0.3em] text-[var(--color-text-muted)] sm:px-6 md:mb-0">
